...
const allClubs = [
  ...
  },
  {
    ...
    mapUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2778.6941551897042!2d15.803896576800645!3d45.8573516138384!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4765cf4c693a0ca5%3A0x8e83315994270275!2sTrg%20žrtava%20fašizma%204%2C%2010290%2C%20Zaprešić!5e0!3m2!1sen!2shr!4v1712845600000!5m2!1sen!2shr",
  },
  {
    name: "GK Samobor",
    city: "Samobor",
...
const allDocuments = [
  {
    title: "Statut Saveza",
    description: "Osnovni dokument koji regulira rad Gimnastičkog saveza Zagrebačke županije.",
  ...
  },
  {
    ...
    description: "Detaljni pravilnik koji uređuje sve aspekte natjecanja i turnira u sezoni 2025./2026.",
    category: "Pravila",
    pdfUrl: "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf",
  ...
  },
  {
    ...
    description: "Pregled svih planiranih aktivnosti, natjecanja i событaja za 2026. godinu.",
    category: "Planiranje",
    pdfUrl: "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf",
  ...
  },
  {
    ...
    description: "Službeni obrazac koji klubovi trebaju ispuniti pri registraciji ili obnovi članstva.",
  ...
  },
  {
    ...
    description: "Godišnji financijski izvještaj Gimnastičkog saveza Zagrebačke županije za 2025. godinu.",
    category: "Financije",
    pdfUrl: "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf",
    createdAt: "2026-01-30T12:00:00Z"
  },
  {
    title: "Kodeks Ponašanja i Etički Standardi",
    description: "Pravila ponašanja i etički standardi za sve članove, trenere i suce saveza.",
    category: "Etika",
    pdfUrl: "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf",
...
const documentsCount = (sqlite.prepare("SELECT COUNT(*) as c FROM documents").get() as { c: number }).c;

console.log(`Existing: ${newsCount} news, ${eventsCount} events, ${clubsCount} clubs, ${resultsCount} results, ${galleryCount} gallery albums, ${documentsCount} documents`);
...
const insertClub = sqlite.prepare(`
  INSERT INTO clubs (name, city, address, phone, email, website, map_url, created_at)
...
const insertDocument = sqlite.prepare(`
  INSERT INTO documents (title, description, category, pdf_url, published, created_at)
  VALUES (?, ?, ?, ?, 1, ?)
`);
...
if (clubsCount === 0) {
  for (const c of allClubs) {
    insertClub.run(c.name, c.city, c.address, c.phone, c.email, c.website, (c as any).mapUrl || "");
  }
...
if (documentsCount === 0) {
  for (const d of allDocuments) {
    insertDocument.run(d.title, d.description, d.category, d.pdfUrl, d.createdAt);
  }
  console.log(`✓ Inserted ${allDocuments.length} documents`);
} else {
  console.log(`  Skipping documents (already has ${documentsCount} rows)`);
}

// ─── SETTINGS ────────────────────────────────────────────────────────────────
const contactMapUrl = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2781.945!2d15.9773!3d45.8131!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4765d6ca4d97e789%3A0x9b11e77e8d4b1e81!2sTrg%20Kre%C5%A1imira%20%C4%86osi%C4%87a%2011%2C%2010000%2C%20Zagreb!5e0!3m2!1sen!2shr!4v1712845600000!5m2!1sen!2shr";
const existingSetting = sqlite.prepare("SELECT value FROM settings WHERE key = 'contactMapIframe'").get();
if (!existingSetting) {
  sqlite.prepare("INSERT INTO settings (key, value, updated_at) VALUES (?, ?, CURRENT_TIMESTAMP)")
    .run('contactMapIframe', contactMapUrl);
  console.log("✓ Inserted default contact map setting");
}

// ─── CLUB MAPS ──────────────────────────────────────────────────────────────
sqlite.prepare("UPDATE clubs SET map_url = ? WHERE name = ?")
  .run('https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2778.6941551897042!2d15.803896576800645!3d45.8573516138384!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4765cf4c693a0ca5%3A0x8e83315994270275!2sTrg%20žrtava%20fašizma%204%2C%2010290%2C%20Zaprešić!5e0!3m2!1sen!2shr!4v1712845600000!5m2!1sen!2shr', 'GK Zaprešić');
console.log("✓ Updated map URL for GK Zaprešić");
