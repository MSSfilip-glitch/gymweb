  ...
  return (
    <div className="min-h-screen bg-white xl:pl-64 flex flex-col overflow-x-hidden">
      ...
      <section className="py-12 bg-gray-50 border-b border-border">
        <div className="container">
          <h2 className="text-3xl font-bold text-secondary mb-8">Lokacije Klubova</h2>
          <div className="relative w-full h-96 bg-gray-200 rounded-lg overflow-hidden shadow-lg">
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-300 to-gray-400">
              <div className="text-center">
                ...
                <p className="text-gray-700 text-lg font-semibold">Interaktivna Mapa</p>
                <p className="text-gray-600 text-sm mt-2">Mapa s lokacijama klubova ce biti dostupna uskoro</p>
              </div>
            </div>
          </div>
        </div>
